...
TEST(Vec3, reflect) {
    ...
    // test with a plane pointing at (1,1)
    {
        ...
        EXPECT_VEC3_NEAR(Vec3::kUnitYNeg.reflect(normal),
                         Vec3(0.6666666f, -0.33333337f, 0.6666666f));
        EXPECT_VEC3_NEAR(Vec3::kUnitYNeg.reflect(-normal),
                         Vec3(0.6666666f, -0.33333337f, 0.6666666f));

        EXPECT_VEC3_NEAR(Vec3::kUnitXNeg.reflect(normal),
                         Vec3(-0.33333337f, 0.6666666f, 0.6666666f));
        EXPECT_VEC3_NEAR(Vec3::kUnitXNeg.reflect(-normal),
                         Vec3(-0.33333337f, 0.6666666f, 0.6666666f));
    }
}
