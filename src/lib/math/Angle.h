...
public:
    ...
    [[nodiscard]] constexpr Angle operator+(Angle angle) noexcept { return mValue + angle.mValue; }
    [[nodiscard]] constexpr Angle operator-(Angle angle) noexcept { return mValue - angle.mValue; }
    [[nodiscard]] constexpr Angle operator*(float value) noexcept { return mValue * value; }
    [[nodiscard]] constexpr Angle operator/(float value) noexcept { return mValue / value; }
    [[nodiscard]] constexpr float operator/(Angle angle) noexcept { return mValue / angle.mValue; }
    // clang-format on
